...
def build_email(date, zscore, closed_today, new_signals, all_trades, system_active):
...
<body style="background:#0a0c0f;color:#c8cdd6;font-family:Arial,sans-serif;
  ...
  <div style="max-width:600px;margin:0 auto;padding:32px 24px">
    ...
    <!-- Footer -->
    <div style="margin-top:32px;padding-top:16px;border-top:1px solid #1e2229;
...
def main():
    ...
    print("\n5. Calculando features y régimen...")
